...
export default function Nav() {
    ...
    return (
        <>
            <nav className="bg-white border-gray-200 -900 max-h-[70px] h-full">
                <div className="container max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 h-full">
                    <Link
                        href="/dashboard"
                    ...
                    <div
                        className={`w-full md:block md:w-auto  ${
                            !toggleNav
                                ? 'hidden'
                                : ' max-md:absolute left-0 top-12'
                        } `}
                        id="navbar-default">
                        <ul
                            className={`  font-medium relative flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-100 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white -800 md:-900 -700`}>
                            <li>
                                <Link
                                    href="/"
                                    className="block py-4 font-normal px-0 border-b-transparent border-b-2 md:hover:border-b-blue-700 text-sm   "
                                    aria-current="page"
                                    onClick={handletoggleNav}>
                                    Home
                                </Link>
                            ...
                            <li>
                                <button
                                    className="block py-4 font-normal px-0 border-b-transparent border-b-2 md:hover:border-b-blue-700 text-sm   "
                                    aria-current="page"
                                    onClick={handletoggleNav && logout}>
                                    logout
                                </button>
                            </li>
                        </ul>
                    ...
                    <div className="flex relative justify-center items-center  ">
                        <ul className="flex h-full items-center text-sm ">
                            ...
                            <li className="h-6 border-l-2 mx-2 hidden md:block"></li>

                            <li className=" hover:bg-blue-100  hidden md:block border-b-2 border-b-transparent hover:border-b-blue-700 h-full py-4 px-2">
                        ...
                        <button
                            ...
                            type="button"
                            className="inline-flex items-center ml-3 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 -400 -gray-700 -gray-600"
